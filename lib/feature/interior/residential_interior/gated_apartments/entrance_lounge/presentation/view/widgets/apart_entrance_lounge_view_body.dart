...
class ApartEntranceLoungeViewBody extends StatelessWidget {
  const ApartEntranceLoungeViewBody({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {

    List<String> directions = ["North east" , "South east" , "North weast" , "South weast" , "Front"];
                ...
                child: Column(
                  children: [
                     const InteriorFirstSection(
                      title: AppStrings.entrance_lounge_title,
                      slash_text: AppStrings.entrance_lounge_slash_text,
                      sub_title: "Design / 3dModeling",
                      bodyText: AppStrings.entrance_lounge_text,
                      centerText: AppStrings.calculate_area,
                      details: AppStrings.calculate_area_details_1,
